...
class Book:
    ...
    def display(self):
        ...
        print(f"Genre: {self.genre}, Price: {self.price}")
        print(f"Status: {status}")


class Patron:
    def __init__(self, patron_id, name, phone, email):
...
while True:
    ...
    if choice == "1":
        ...
        library.add_book(Book(book_id, title, author, genre, price))
        ...
        library.register_patron(Patron(patron_id, name, phone, email))
